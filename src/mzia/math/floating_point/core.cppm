...
export module mzia.math.floating_point.core;

import std;

import mzia.math.integer.core;
...
// forward declaration
export namespace mzia::ieee754_float {
...
#else
using f128 = ::mzia::ieee754_float::f<128>;
#endif
