...
export module mzia.util.misc.tower_of_hanoi;

import std;

import mzia.math.integer;

namespace mzia::tower_of_hanoi {
...
namespace mzia::tower_of_hanoi::get_move_cnt {
...
namespace mzia::tower_of_hanoi::print_moves {
