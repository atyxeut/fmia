...
export module mzia.util.std_extension.container;

import std;

import mzia.memory.core;
import mzia.util.std_extension.meta;
...
export namespace mzia {

// sets every element of a mzia::array to val
// mzia::array<int, 3, 5, 2, 10> arr4d;
// int val = -1;
// mzia::fill_array(arr4d, val);
...
// auto arr4d = mzia::make_array<int, 5, 8, 3, 2>(val);
// combines `mzia::array<int, 5, 8, 3, 2> arr4d` and `mzia::fill_array(arr4d, val)`
...
// mzia::vector<int> vec1d;
// same as: std::vector<int> vec1d;
//
// mzia::vector<int, 4> vec4d;
