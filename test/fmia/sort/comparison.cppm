...
void check_insertion_sort_correctness() {
...
void check_selection_sort_correctness() {
  auto arr = random::rand_number_vector(array_size_small);
...
void check_bubble_sort_correctness() {
  auto arr = random::rand_number_vector(array_size_small);
...
void check_heap_sort_correctness() {
...
void check_hoare_quick_sort_correctness() {
  auto arr = random::rand_number_vector(array_size_large);
  hoare_quick_sort(arr.begin(), arr.end());
  contract_assert(std::ranges::is_sorted(arr) && arr.front() <= arr.back());
}

void check_bentley_mcilroy_quick_sort_correctness() {
  auto arr = random::rand_number_vector(array_size_large);
  bentley_mcilroy_quick_sort(arr.begin(), arr.end());
  contract_assert(std::ranges::is_sorted(arr) && arr.front() <= arr.back());
}

void check_merge_sort_correctness() {
  auto arr = random::rand_number_vector(array_size_large);
