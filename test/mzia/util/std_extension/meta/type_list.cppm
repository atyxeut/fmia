...
export module test.mzia.util.std_extension.meta.type_list;

import std;

import mzia.util.std_extension.meta.core;
import mzia.util.std_extension.meta.type_list;

namespace test::mzia::meta { using namespace ::mzia::meta; } // namespace test::mzia::meta

export namespace test::mzia::meta {
