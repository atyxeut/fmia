...
export module test.mzia.util.std_extension.container;

import std;

import mzia.memory.core;
import mzia.util.std_extension.container;

namespace test::mzia::util { using namespace ::mzia; } // namespace test::mzia::util

export namespace test::mzia::util {

consteval void mzia_array_should_be_nested_std_array() noexcept
{
...
consteval void mzia_vector_should_be_nested_std_vector() noexcept
{
...
consteval void every_empty_allocator_template_parameter_of_mzia_vector_defaults_to_std_allocator() noexcept
{
