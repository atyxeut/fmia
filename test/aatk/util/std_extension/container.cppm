...
export module test.aatk.util.std_extension.container;
...
consteval void aatk_array_should_be_nested_std_array() noexcept
{
...
consteval void aatk_vector_should_be_nested_std_vector() noexcept
{
...
consteval void every_empty_allocator_template_parameter_of_aatk_vector_defaults_to_std_allocator() noexcept
{
